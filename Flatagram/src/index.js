...
function renderImage(image) {
    ...
    const downVoteButton = document.createElement('button')
        ...
        downVoteButton.addEventListener('click', (e) => {
            alert("I can't believe you tried to downvote this puppy. Not gonna happen. But see downVoteImage function in index.js for logic if necessary or uncomment the line of code below this alert in index.js (line 32) to see working.")
            // downVoteImage(e)
        })
